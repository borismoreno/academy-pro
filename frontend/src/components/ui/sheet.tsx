 ...
 * Kinetic Edge: bg-surface-high, rounded-t-[1.5rem], no border.
 */
  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-surface-high rounded-t-[1.5rem]',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-display text-[1.25rem] font-semibold text-on-surface', className)}
    {...props}
  />
));
