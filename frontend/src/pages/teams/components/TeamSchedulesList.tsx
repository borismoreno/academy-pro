...
export default function TeamSchedulesList({ schedules, teamId, role }: TeamSchedulesListProps) {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-3">
            {schedules.map((s) => (
              <div key={s.id} className="flex items-center gap-3">
                {/* Day chip */}
                <span className="flex-shrink-0 font-body text-[0.6875rem] uppercase tracking-[0.05em] bg-surface-highest text-primary rounded-full px-3 py-1">
      ...
      <AddScheduleSheet open={addOpen} onOpenChange={setAddOpen} teamId={teamId} />
