...
export default function LogoUploader({ currentLogoUrl, onUploadComplete }: Props) {
    ...
    <div className="flex flex-col items-start gap-3">
      <div className="w-24 h-24 rounded-full overflow-hidden bg-surface-highest flex items-center justify-center shrink-0">
        {uploadState === 'uploading' ? (
          ...
          <img src={previewUrl} alt="Logo de la academia" className="w-full h-full object-cover" />
        ) : (
