      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-high rounded-b-[1.5rem] px-8 py-12 shadow-[0px_24px_48px_rgba(0,0,0,0.5)] flex flex-col items-center gap-6 text-center">
          ...
          <button
            ...
            className="inline-flex items-center justify-center h-11 px-6 text-sm font-semibold rounded-xl bg-gradient-to-br from-primary to-secondary text-on-primary transition-opacity hover:opacity-90 cursor-pointer"
          >
            Volver al inicio
          </button>
        </div>
